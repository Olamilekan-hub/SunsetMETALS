...
const features = [
  {
    ...
    description:
      "Raised seams and concealed fasteners prevent water infiltration",
  },
  {
    icon: Wind,
    title: "High Wind Resistance",
    description:
      "Engineered to withstand winds up to 185 mph when properly installed",
  },
  {
    icon: Thermometer,
    title: "Thermal Movement",
    description:
      "Floating clip system allows for natural expansion and contraction",
  },
  {
    icon: CheckCircle,
...
export default function StandingSeamPage() {
  ...
  const productImageSrc = "/profiles/snaplock/snaplock orange.jpg";
  const productImageAlt = "Snaplock Profile Profile";
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-200 mb-6">
                Premium architectural metal roofing with concealed fasteners and
            ...
            >
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                {show3D ? (
                  <ModelViewer3D
                    src="/models/Snaplock-Profile.glb"
                    alt="Snaplock Profile Profile 3D Model"
                    className="w-full h-64"
                    cameraOrbit="0deg 70deg 18m"
              ...
              >
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 text-white">
                  {features.map((feature) => (
                    <div
                      key={feature.title}
                      className="bg-[#5A6B4F] rounded-lg p-6 shadow-lg"
                    >
                ...
                <div className="bg-[#5A6B4F] text-white rounded-lg p-8 shadow-lg">
                  <h3 className="text-2xl font-bold text-metal-dark mb-6">
                    Ideal Applications
                  </h3>
      ...
      <section className="text-center border-t border-white py-12 bg-[#8D9E76]">
        <div className="bg-gradient-to-r from-forest-green to-sunset-orange rounded-2xl p-12">
          ...
          <p className="text-white/90 mb-8 max-w-2xl mx-auto">
            Contact our experts to discuss your Snaplock Profile roofing project
