...
export default function StandingSeamPage() {
  ...
  const productImageSrc = "/profiles/trapezoid/trapazoid orange.jpg";
  const productImageAlt = "Trapezoid Profile";
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                {show3D ? (
                  <ModelViewer3D
                    src="/models/trapezoid.glb"
                    alt="Trapezoid Profile 3D Model"
                    className="w-full h-64"
                    cameraOrbit="0deg 70deg 4m"
      ...
      <section className="text-center border-t border-white py-12 bg-[#8D9E76]">
        <div className="bg-gradient-to-r from-forest-green to-sunset-orange rounded-2xl p-12">
          ...
          <p className="text-white/90 mb-8 max-w-2xl mx-auto">
            Contact our experts to discuss your Snaplock Profile roofing project and get a custom quote.
          </p>
